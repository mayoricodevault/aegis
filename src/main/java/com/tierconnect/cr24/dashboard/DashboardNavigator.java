...
import com.tierconnect.cr24.dashboard.event.DashboardEvent.PostViewChangeEvent;
import com.tierconnect.cr24.dashboard.event.DashboardEventBus;
import com.tierconnect.cr24.dashboard.view.DashboardViewType;
...
public class DashboardNavigator extends Navigator {
    ...
    public DashboardNavigator(final ComponentContainer container) {
        ...
        if (TRACKER_ID != null && host.endsWith("poc.cr24.com")) {
    ...
    private void initGATracker(final String trackerId) {
        tracker = new GoogleAnalyticsTracker(trackerId, "poc.cr24.com");

package com.tierconnect.cr24.dashboard.data.dummy;
...
import com.tierconnect.cr24.dashboard.domain.*;
...
public class DummyDataProvider implements DataProvider {
    ...
    private static Collection<Movie> loadMoviesData() {
        ...
        System.out.println(vaadinRequest.getService().getBaseDirectory());
    ...
    private static Multimap<String, String> loadTheaterData() {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(
                DummyDataProvider.class.getResourceAsStream("jobs.txt")));
